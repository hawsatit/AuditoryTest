...
public class SequenceBankB1 {
    ...
    public static List<Sequence> getAllSequences() {
        ...
        sequences.add(new Sequence(List.of("B2", "A2", "A2", "B1"), true));
        ...
        sequences.add(new Sequence(List.of("B2", "A2", "A1", "A2", "A1"), false));
